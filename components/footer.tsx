        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6">
              Leading provider of automated premium coffee solutions across Europe. 
              Building profitable partnerships one station at a time.
            </p>
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <Mail className="h-4 w-4 text-orange-500" />
                <span>franchise@coffeehubpro.com</span>
              </div>
              <div className="flex items-center space-x-2">
                <Phone className="h-4 w-4 text-orange-500" />
                <span>+43 664 123-45-67</span>
              </div>
              <div className="flex items-center space-x-2">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/locations" className="text-gray-300 hover:text-white transition-colors">Find Locations</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/legal-info" className="text-gray-300 hover:text-white transition-colors">Legal Information</Link></li>
              <li><Link href="/privacy" className="text-gray-300 hover:text-white transition-colors">Privacy Notice</Link></li>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2024 CoffeeHub Pro. All rights reserved. A premium coffee solution company based in Austria.
            </p>
            <div className="flex space-x-4">
              ...
              <Link href="#" className="text-gray-400 hover:text-white transition-colors">WhatsApp</Link>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-900 py-4 px-4">
        <div className="max-w-6xl mx-auto">
          <p className="text-sm text-gray-400 text-center">
            ...
            <Link href="/cookie-policy" className="text-orange-500 hover:text-orange-400 ml-1">Learn more</Link>
          </p>
        </div>
      </div>
    </footer>
