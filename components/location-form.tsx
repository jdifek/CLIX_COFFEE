...
export default function LocationForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert(
      "Thank you for your submission! Our location team will contact you within 24 hours."
    );
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        <Label htmlFor="ownershipType" className="text-gray-700">
          How can you help us? *
        </Label>
        <Select onValueChange={(value) => handleChange("ownershipType", value)}>
          ...
          <SelectContent>
            <SelectItem value="own-property">
              I own/manage property suitable for a coffee station
            </SelectItem>
            <SelectItem value="know-locations">
              I know great locations and can connect you with owners
            </SelectItem>
            <SelectItem value="local-expert">
              I'm a local expert who can help scout locations
            </SelectItem>
      ...
      <div>
        <Label htmlFor="locationType" className="text-gray-700">
          What type of location(s) are you referring?
        </Label>
        <Select onValueChange={(value) => handleChange("locationType", value)}>
          ...
          <SelectContent>
            ...
            <SelectItem value="shopping-center">
      ...
      <div>
        <Label htmlFor="locationDetails" className="text-gray-700">
          Location Details *
        </Label>
        <Textarea
          id="locationDetails"
      ...
      <p className="text-sm text-gray-600 text-center">
        By submitting this form, you agree to partner with Clix Coffee Pro on
        location development. We will contact you within 24 hours to discuss
        potential rewards and next steps.
      </p>
    </form>
  );
}
