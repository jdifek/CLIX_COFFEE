...
export default function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <h3 className="text-2xl font-bold text-gray-800 mb-6">Start Your Coffee Business Journey</h3>
      
      <div className="grid md:grid-cols-2 gap-6">
        <div>
          <Label htmlFor="quantity" className="text-gray-700">How many stations are you interested in?</Label>
        ...
        <div>
          <Label htmlFor="timeline" className="text-gray-700">When do you plan to launch?</Label>
      ...
      <div>
        <Label htmlFor="funding" className="text-gray-700">How will you finance this investment?</Label>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div>
          <Label htmlFor="phone" className="text-gray-700">WhatsApp Number *</Label>
          <Input
            type="tel"
            id="phone"
            required
      ...
      <p className="text-sm text-gray-600 text-center">
        By submitting this form, you agree to be contacted about CoffeeHub Pro business opportunities. 
